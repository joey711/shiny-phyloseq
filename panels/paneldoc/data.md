...
beginning with data selection, filtering/curation, transformation, 
graphic-specific panels, and ending with `Provenance`.
...
sample- or OTU-networks (`Network` and `d3Netowrk`), 
bar plot (`Bar`), 
heat map (`Heatmap`), 
