...
sbp_prov = sidebarPanel(
  ...
  fluidRow(column(width = 12,
    ...
    div(class='span6', div(style="display:inline-block", tags$label(div(icon("code"), icon("archive"))),
  ...
  fluidRow(column(width = 12,
                  ...
                  div(class='span9', div(style="display:inline-block", tags$label(icon("code")),
